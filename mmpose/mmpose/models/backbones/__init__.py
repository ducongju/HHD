...
from .hrnet_small import HRNet_small
from .hrnet_teather import HRNet_teather
...
__all__ = [
    'AlexNet', 'HourglassNet', 'HourglassAENet', 'HRNet', 'HRNet_small','HRNet_teather','MobileNetV2',
