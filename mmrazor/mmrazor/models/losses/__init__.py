...
from .js_discret_loss import JSDiscretLoss
from .hhd_loss import HHDLoss
from .crop_loss import CropLoss
from .cropbias_loss import CropbiasLoss
...
__all__ = [
    ...
    'DISTLoss','JSDiscretLoss','HHDLoss','CropLoss','CropbiasLoss'
]
